...
class RandomForest:
    ...
    def _check_types(self) -> None:
        ...
        if not isinstance(self.random_subspace_node, (str, int)):
            raise TypeError(
...
class DecisionForest:
    ...
    def F(self):
        method_functions = {'runif': lambda n: np.random.randint(1, n + 1),
                            'in25': lambda n: int(n / 4),
                            'int50': lambda n: int(n / 2),
                            'int75': lambda n: int(3 * n / 4)}
        if self.max_random_features in method_functions.keys():
            return method_functions[self.max_random_features](self.n_features)
        else:
            raise TypeError('max_random_features must be "in25", '
                            '"in50", "int75" or "runif"')
    ...
    def fit(self, X: np.ndarray, y: np.ndarray) -> None:
        ...
        for tree in trees:
            ...
            X_random_feature, features_idxs = self._random_features(X,
                                                                    random_state)
            print('n features', X_random_feature.shape)
...
# class DecisionForest22(BaseForest):
#     def __init__(self,
#                  random_state: int = 0,
#                  n_trees: int = 100,
#                  max_depth: int = 2,
...
#
#
# class RandomForest22(BaseForest):
#     def __init__(self,
#                  random_state,
#                  n_trees,
#                  max_depth,
